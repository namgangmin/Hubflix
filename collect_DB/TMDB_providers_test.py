...
for movie_id in range(2, 10000):
    url = f'https://api.themoviedb.org/3/movie/{movie_id}/watch/providers?api_key={api_key}&language=ko-KR'
    print(url)
    ...
    if "success" in data:
         continue
    movie_provider_result = data["results"]
...
with open('movie_provider_2to10000.json', "w", encoding='utf-8') as f:
